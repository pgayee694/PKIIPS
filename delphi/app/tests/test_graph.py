...
class TestPKI(unittest.TestCase):
    ...
    def test_update_room(self):
        pki = PKI()
        assert pki.edges == {'sa': [('s1', 1000), ('s2', 1000), ('s3', 1000)], 's1': [('h1', 25)], 's2': [('h1', 30)],
                             's3': [('h1', 20)], 'h1': [('h2', 80)], 'h2': [('h5', 75), ('t1', 25)],
                             't1': [('ta', 1000)],
                             't2': [('ta', 1000)], 'h5': [('t2', 80)]}
        pki.update_room('s1', 30)
        assert pki.edges == {'sa': [('s1', 1000), ('s2', 1000), ('s3', 1000)], 's1': [('h1', 30)], 's2': [('h1', 30)],
                             's3': [('h1', 20)], 'h1': [('h2', 80)], 'h2': [('h5', 75), ('t1', 25)],
                             't1': [('ta', 1000)],
                             't2': [('ta', 1000)], 'h5': [('t2', 80)]}
