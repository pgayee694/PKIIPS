    ...
    def setEdges(self):
        ...
        self.edge_levels = {
            "l1": {"sa": [("252", 1000), ("256", 1000), ('260', 1000)], "252": [("h1", self.room_counts['252'])],
                   "256": [("h1", self.room_counts['256'])], "260": [("h1", self.room_counts['260'])],
                   "h1": [("h2", 80)],
                   "h2": [("h5", 75), ("t1", 25)], "t1": [("ta", 1000)], "t2": [("ta", 1000)], "h5": [("t2", 80)]},
            "l2": {"252": [("h1", self.room_counts['252'] / 2), ("h3", self.room_counts['252'] / 2)],
                   "h3": [("h4", 20)],
                   "h4": [("t3", 20), ("t4", 20)], "t3": [("ta", 1000)],
                   "t4": [("ta", 1000)], "h1": [("h2", 80), ("h3", 40)]},
            'l3': {"260": [("h1", self.room_counts['260'] / 2), ("h6", self.room_counts['260'] / 2)],
                   "h6": [("h4", 30)]}}
